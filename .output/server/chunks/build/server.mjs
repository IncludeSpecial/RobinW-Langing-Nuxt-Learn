...
import { $ as $fetch$1, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, h as createError$1, o as klona, p as defu, q as sanitizeStatusCode, r as defuFn, t as createHooks, v as toRouteMatcher, x as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-C7hWLNfD.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-BkS1G7Xz.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-B2GqmqQH.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-DR-mV-Th.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, navigateTo as a, useRuntimeConfig as b, useNuxtApp as c, useAppConfig as d, entry$1 as default, asyncDataDefaults as e, createError as f, resolveUnrefHeadInput as g, injectHead as i, nuxtLinkDefaults as n, resolveRouteObject as r, useRouter as u };
