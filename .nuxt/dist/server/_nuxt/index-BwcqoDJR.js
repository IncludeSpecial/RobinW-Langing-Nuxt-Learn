...
import { defineComponent, unref, mergeProps, withCtx, renderSlot, useSSRContext, createTextVNode, toDisplayString, defineAsyncComponent, createVNode, computed, ref, h, resolveComponent, openBlock, createBlock, Fragment, renderList } from "vue";
import { ssrRenderComponent, ssrRenderSlot, ssrRenderAttrs, ssrRenderAttr, ssrInterpolate, ssrRenderList, ssrRenderClass } from "vue/server-renderer";
import { Primitive } from "radix-vue";
import { clsx } from "clsx";
import { twMerge } from "tailwind-merge";
import { _ as _export_sfc, c as useRequestEvent, d as useNuxtApp, b as useRuntimeConfig } from "../server.mjs";
import __nuxt_component_2 from "./index-CEEbGvwu.js";
import { u as useHead, a as useSeoMeta } from "./index-BxLiCpJA.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div>`);
      if (showModal.value) {
        _push(`<div class="fixed inset-2 z-50 flex items-center justify-center bg-black bg-opacity-75"><div class="relative bg-white rounded-lg"><button class="absolute top-2 right-2 px-2 items-center justify-center rounded-full bg-primary text-center text-gray-700 text-4xl hover:text-gray-900"> × </button>`);
        _push(ssrRenderComponent(_component_LazyNuxtImg, {
...
//# sourceMappingURL=index-BwcqoDJR.js.map
